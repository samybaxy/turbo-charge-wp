...
class SHYPDR_Content_Analyzer {
    ...
    private static $elementor_widget_map = [
        ...
        'wc-mini-cart' => 'woocommerce',
        'woocommerce-mini-cart' => 'woocommerce',
        ...
        'woocommerce-archive-products' => 'woocommerce',
        'woocommerce-archive-description' => 'woocommerce',
        'woocommerce-product-categories' => 'woocommerce',
        'woocommerce-breadcrumb' => 'woocommerce',
        'woocommerce-notices' => 'woocommerce',
